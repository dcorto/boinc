...
* `1.1.4`, `1.1`, `latest` - [(Dockerfile)](https://github.com/dcorto/boinc/blob/v1.1.4/Dockerfile) - [CHANGELOG](https://github.com/dcorto/boinc/blob/v1.1.4/CHANGELOG.md)

* `1.1.3` - [(Dockerfile)](https://github.com/dcorto/boinc/blob/v1.1.3/Dockerfile) - [CHANGELOG](https://github.com/dcorto/boinc/blob/v1.1.3/CHANGELOG.md)
